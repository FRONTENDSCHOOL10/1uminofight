    ...
    footerContainer.innerHTML = `
      <div class="footer-content">
        ...
        <div class="company-info">
          ...
          <ul class="social-links">
            <li><a href="#"><img src="../../assets/icon/ico_naver.png" alt="블로그" /></a></li>
            <li><a href="#"><img src="../../assets/icon/ico_facebook.png" alt="페이스북" /></a></li>
            <li><a href="#"><img src="../../assets/icon/ico_instagram.png" alt="인스타그램" /></a></li>
            <li><a href="#"><img src="../../assets/icon/ico_naverpost.png" alt="네이버 포스트" /></a></li>
            <li><a href="#"><img src="../../assets/icon/ico_youtube.png" alt="유튜브" /></a></li>
          </ul>
        </div>
      </div>
      ...
      <ul class="certifications">
        <li>
          <figure>
            <div>
              <img src="../../assets/icon/isms.png" alt="ISMS" />
            </div>
            <figcaption>
        ...
        <li>
          <figure>
            <div>
              <img src="../../assets/icon/privacy.png" alt="PRIVACY 로고" />
            </div>
            <figcaption>
        ...
        <li>
          <figure>
            <div>
              <img src="../../assets/icon/tosspayments.png" alt="toss payments 로고" />
            </div>
            <figcaption>
        ...
        <li>
          <figure>
            <div>
              <img src="../../assets/icon/wooriBank.png" alt="우리은행" />
            </div>
            <figcaption>
